...
<div class="container">
    <form action="login.php" method="post"class="login active">
        ...
        <p>I don't have an account. <a href="../PHP/registration.php" >Register</a></p>
    </form>
</div>
...
if(isset($_POST['submit'])){
    ...
    $email_password_check = "select * from user where email='$email' and password = '$password'";
    ...
    if(mysqli_num_rows($email_password_result)){
        ...
        if($pass['password']==$password){
            $user = "select id,name,email,phone,password from user where email='$email'";
        ...
        echo"<center>Incorrect email or password. New user? <button class='btn signup'><a href='../PHP/registration.php' >Signup here</a></button><center>";
    }
