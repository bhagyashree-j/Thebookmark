    ...
    <header class="header">
        ...
        <div class="header-2">
            <nav class="navbar">
                ...
                <a href="../PHPcontactus.php">Contact us</a>
            </nav>
        </div>
...
if (isset($_POST['submit'])) {
    ...
    if ($oldpwd == $oldp) {
        if ($newp == $confirmp) {
            ...
            $change = "update register set password='$newp' where email = '$email'";
            $change_result = mysqli_query($con, $change) or die(mysqli_error($con));
            echo "<center><h4>Password successfully changed</h4></center>";
            $oldpwd = $oldp;
            echo "<center><h4><button><a href='../PHP/home.php'>Back</a></button><h4><center>";
        } else {
